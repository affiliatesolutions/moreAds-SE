...
class MASE_Zones_Banner {
    ...
    public static function wp_ajax_mase_banner_zone() {
        $widget_number = (int) isset($_GET['widget_number']) ? $_GET['widget_number'] : false;
        $widget_id = isset($_GET['widget_id']) ? $_GET['widget_id'] : false;
        $selected_size = isset($_GET['size']) ? $_GET['size'] : false;
    ...
    public static function wp_ajax_mase_banner_zone_save() {
        ...
        $zone_identifier = MASE_PREFIX.'banner_zone_ads_'.$_REQUEST['widget_number'];
